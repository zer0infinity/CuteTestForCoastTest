...
namespace testframework
{
	...
	public:
		...
		{
		public:
			CatchTime(String strTestName, StatisticPolicyType *theTest, char delim = '/', char indexdelim = ':')
	...
	protected:
		...
		void LoadData(String strClassName, String strTestName) {
...
//			fStatistics.SortByKey();
		...
		void AddStatisticOutput(String strSummaryName, long lMilliTime, char delim = '/', char indexdelim = ':') {
