...
namespace testframework {
	...
	public:
		...
		bool loadConfig(String strClassName, String strTestName) {
	...
	protected:
		...
		String fCfgFileName, fTestCaseName;

		virtual String getConfigFileName() {
			return fCfgFileName;
		}
		...
		virtual bool DoLoadConfig(String strClassName, String strTestName) {
