{0, "((a|b{10,11})|(b))*-\\2", "aaab-a"}, { //SOP fails to match ?
	0, "(a)*-\\1", "aaa-a"},
{1, "(a)*-\\1b", "aaa-b"},
{2, "([xyz])(-\\2)", "x-y"}, { // SOP invalid backreference 1 -> 2
	1, "(([xyz])(-\\2))", "x-y"},
{0, "(([xyz])(-\\2)*)*", "x-y"},
{0, "(([xyz])(-\\2)*)*", "x-"},
{0, "(([xyz])(-\\2)*)*", "xy-yz-y"},
{2, "((.*)\\1)+", "xxxxxx"}, { // SOP not allowed because of nullable of second * operand and invalid backref, 1->2
...
{0, "", ""},
{0, "b{0,6}", ""},
{2, "ab{0,0}c", "abc"}, { // SOP invalid range 1-->2
	1, "ab{1,1}c", "abbc"},
...
{1, "ab{3,7}c", "abbc"},
{1, "ab{3,7}c", "abc"},
{2, "[]][[.].]][[.right-square-bracket.]]	a]]]", "foo"}, { // SOP: what POSIX do we (and others) support ?? 1-->2
	0, "a*a*", "aaaaaa"},
{0, "a*a*a*", "aaaaaa"},
{0, "(.*)\\1\\1", "aaa"},
{0, "(a|b)*c|(a|ab)*c", "xc"},
...
{0, "(..)*(...)*", "a"},
{0, "(..)*(...)*", "abc"},
{2, "(.*)*\\1", "xx"}, { // SOP not allowed because of nullable of second * operand, 0->2
	0, "^", ""},
{0, "$", ""},
{0, "^$", ""},
{0, "^a$", "a"},
...
{0, "ab|cd", "abcd"},
{0, "()ef", "def"},
{2, "()*", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	2, "*a", "-"}, { // SOP no closure operand, 1->2
	2, "^*", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	2, "$*", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	2, "(*)b", "-"}, { // SOP no closure operand, 1->2
	1, "$b", "b"},
{2, "a\\", "-"},
{0, "a\\(b", "a(b"},
{0, "a\\(*b", "ab"},
{0, "a\\(*b", "a((b"},
{1, "a\\y", "a\\y"}, { // SOP y was x which is for hex-digits now...
	2, "abc)", "-"}, { // SOP superfluous close paren 1->2
	2, "(abc", "-"},
{0, "((a))", "abc"},
{0, "(a)b(c)", "abc"},
{0, "a+b+c", "aabbabc"},
{2, "a**", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	0, "a*?", "-"},
{2, "(a*)*", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	2, "(a*)+", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	2, "(a|)*", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	2, "(a*|b)*", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	0, "(a+|b)*", "ab"},
{0, "(a+|b)+", "ab"},
{0, "(a+|b)?", "ab"},
{0, "[^ab]*", "cde"},
{2, "(^)*", "-"}, { // SOP not allowed because of nullable of second * operand, 1->2
	2, "(ab|)*", "-"}, { // SOP not allowed because of nullable of second * operand, 0->2
	2, ")(", "-"},
{1, "abc", ""},
{1, "abc", ""},
{0, "a*", ""},
