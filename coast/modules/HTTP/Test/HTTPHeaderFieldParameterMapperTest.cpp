...
namespace {
	...
	void unregisterMappers() {
		StartTrace(HTTPHeaderFieldParameterMapperTest.unregisterMappers);
...
Test *HTTPHeaderFieldParameterMapperTest::suite() {
	StartTrace(HTTPHeaderFieldParameterMapperTest.suite);
	TestSuite *testSuite = new TestSuite;
	ADD_CASE(testSuite, HTTPHeaderFieldParameterMapperTest, ConfiguredTests);
	return testSuite;
}
