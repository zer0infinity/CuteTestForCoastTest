...
bool NTLMCoder::DecodeClientMsg(const String &base64msg, String &domain, String &host)
{
	...
	String dm;
	if (DecodeBase64(dm, base64msg)
		&&
		"NTLMSSP" == dm.SubString(0L, 7L) &&
		'\x01' == dm[8L] &&
		'\x03' == dm[12L] &&
		'\xb2' == dm[13L]
	   ) {
...
bool NTLMCoder::DecodeServerNonce(const String &base64msg, String &nonce)
{
	...
	if (DecodeBase64(dm, base64msg)
		...
		Trace("nonce = " << nonce); // should be hex?
		return true;
	}
	return false;
}
...
bool NTLMCoder::DecodeResponse(const String &base64msg, const String &nonce,
...
String NTLMCoder::EncodeResponse(const String &nonce,
								 const String &lmhash, const String &nthash,
