...
//		/FormName					optional, Rendererspec, Name of the form in which this list resides, used for OnLoad and other scripts
//									! specify when using ClientSideRendering or EditableList !
//		/ClientSideRendering		optional, 1 or 0, default 0, fill list contents on client using JavaScript
//		/EditableList				optional, 1 or 0, default 0:
