...
def generate(env, **kw):
    ...
    StanfordUtils.DependsOn(env, 'iplanetLDAP')
    StanfordUtils.DependsOn(env, 'openssl')
    StanfordUtils.DependsOn(env, 'CoastDataAccess')
    StanfordUtils.DependsOn(env, 'CoastSecurity')
