...
//! }
//! </PRE>
//! storing the index in tmpStore at /IndexSlot
//! If Start greater than end the loop counts downward
...
private:
	//!Utility method to Render config and converting the result into a long
	long GetLong(Context &ctx, const ROAnything &config);
};
